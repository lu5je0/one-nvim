...
----------------------------------
     ...
     Ignore         = { fg = none},
     Error          = { fg = hue_5, bg = none,   style = 'bold'},
...
LspDiagnosticsDefaultError           = { fg = hue_5 , bg = none},
LspDiagnosticsDefaultWarning         = { fg = hue_6_2  , bg = none},
LspDiagnosticsDefaultInformation     = { fg = hue_1  , bg = none},
LspDiagnosticsDefaultHint            = { fg = hue_4  , bg = none},
...
LspDiagnosticsSignError              = { fg = hue_5  , bg = none},
LspDiagnosticsSignWarning            = { fg = hue_6_2  , bg = none},
LspDiagnosticsSignInformation        = { fg = hue_1  , bg = none},
LspDiagnosticsSignHint               = { fg = hue_4  , bg = none},
